<template>
  ...
  <!-- Display Promos -->
  <div class="px-5 flex flex-col gap-5 mt-4">
    
    <!-- State Jika Promo Kosong -->
    <div v-if="promos.length === 0" class="flex flex-col items-center justify-center py-16 text-center">
      <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-3">
        <i class="fa-solid fa-tags text-2xl text-gray-300"></i>
      </div>
      <h3 class="text-sm font-bold text-gray-800">Belum Ada Promo</h3>
    ...
    <div 
      ...
      class="relative w-full h-[220px] rounded-3xl overflow-hidden shadow-md group cursor-pointer"
    >
      <NuxtImg 
        :src="promo.image" 
        :alt="promo.title" 
...
// Data Dummy Promo (Kosong untuk melihat state)
const promos = ref([])
